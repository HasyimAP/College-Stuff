...
<MetaResultFile version="20200629" creator="Solver HFTD - Field 3DFD Monitor">
  ...
  <SimulationProperties fieldname="power (f=2.6) [1]" fieldtype="Powerflow" frequency="2.5999999046325684" encoded_unit="&amp;U:V^1.:A^1.:m^-2" fieldscaling="TIME_AVERAGE" dB_Amplitude="10"/>
